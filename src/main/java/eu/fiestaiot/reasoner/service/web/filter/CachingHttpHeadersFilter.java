package eu.fiestaiot.reasoner.service.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(FiestaProperties fiestaProperties) {
        this.fiestaProperties = fiestaProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(fiestaProperties.getHttp().getCache().getTimeToLiveInDays());
    }
